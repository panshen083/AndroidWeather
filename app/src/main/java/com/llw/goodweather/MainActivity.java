...
import com.llw.goodweather.utils.RecyclerViewAnimation;
...
import static com.llw.goodweather.utils.RecyclerViewAnimation.runLayoutAnimation;
import static com.llw.goodweather.utils.RecyclerViewAnimation.runLayoutAnimationRight;
...
//        tv_pop.setText(data.getPop() + "%");//V7 版本中，天气预报中没有降水概率这个值
     ...
     * @param view 控件
     */
    @OnClick({R.id.iv_add, R.id.tv_warn, R.id.tv_city})
